...
{% if latest_chart.home %}[Home]({{ latest_chart.home }}){% endif %}
{% if latest_chart.home and latest_chart.sources[0] %} | {% endif %}
{% if latest_chart.sources[0] %}[Source]({{ latest_chart.sources[0] }}){% endif %}
